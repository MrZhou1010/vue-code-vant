<template>
	<div class="count-down">
		...
		<div class="content">
			...
			<van-count-down style="margin: 10px;" :time="time" format="DD天HH时mm分ss秒" />
			<!-- 毫秒级渲染 -->
			<div style="color: #666666;">毫秒级渲染</div>
			<van-count-down style="margin: 10px;" :time="time" format="HH:mm:ss:SS" millisecond />
			<!-- 自定义样式 -->
			...
			<van-count-down style="margin: 10px;" ref="countDown" :time="30000" :auto-start="false"
				format="HH:mm:ss:SSS" millisecond @finish="finish" />
			<van-grid clickable>
