<template>
	<div class="collapse">
		...
		<div class="content">
			...
			<van-collapse style="margin: 10px 0;" v-model="activeNames3" :border="false">
				<van-collapse-item title="标题1" name="1">内容1</van-collapse-item>
				<van-collapse-item title="标题2" name="2" :is-link="false">内容2</van-collapse-item>
				<van-collapse-item title="标题3" name="3" disabled>内容3</van-collapse-item>
			</van-collapse>
			<!-- 自定义标题内容 -->
			...
			<van-collapse style="margin: 10px 0;" v-model="activeNames4">
				<van-collapse-item name="1">
					<template #title>
						<div>标题1
							<van-icon name="question-o" color="#ff00ee" />
						</div>
					</template>
					内容1
					<template #value>
				...
				<van-collapse-item title="标题2" name="2" value="内容">
					<template #icon>
						<div>
							<van-icon name="shop-o" color="#cc66ee" size="22" />
						</div>
					</template>
					内容2
				</van-collapse-item>
				<van-collapse-item title="标题3" name="3" label="描述内容" size="large">内容3</van-collapse-item>
			</van-collapse>
		</div>
	</div>
</template>
