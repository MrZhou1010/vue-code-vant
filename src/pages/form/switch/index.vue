<template>
	<div class="switch">
		...
		<div class="content">
			...
			<van-switch class="item-switch" v-model="checked5" active-color="#ee0a24" inactive-color="#6a5e8e" />
			<!-- 自定义值 -->
			<div style="color: #666666;">自定义值</div>
			<van-switch class="item-switch" v-model="checked6" active-value="开" inactive-value="关" @change="onChange" />
			<!-- 异步控制 -->
