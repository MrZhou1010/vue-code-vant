<template>
	<div class="picker">
		...
		<div class="content">
			...
			<van-cell is-link title="顶部栏" :value="selectedValue2" @click="showPopup2 = true" />
			...
			<van-cell is-link title="顶部栏位置" :value="selectedValue3" @click="showPopup3 = true" />
			<van-popup v-model="showPopup3" position="bottom" round>
				<van-picker :title="selectedValue3 || '标题'" show-toolbar toolbar-position="bottom" :columns="columns3"
					@confirm="onConfirm3" @cancel="showPopup3 = false" />
			</van-popup>
			<van-cell is-link title="默认选中项" :value="selectedValue4" @click="showPopup4 = true" />
			<van-popup v-model="showPopup4" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns4" :default-index="2" @confirm="onConfirm4"
					@cancel="showPopup4 = false" />
			</van-popup>
			<van-cell is-link title="只读状态" :value="selectedValue5" @click="showPopup5 = true" />
			<van-popup v-model="showPopup5" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns5" readonly @confirm="onConfirm5"
					@cancel="showPopup5 = false" />
			</van-popup>
			<van-cell is-link title="禁用选项" :value="selectedValue6" @click="showPopup6 = true" />
			<van-popup v-model="showPopup6" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns6" @confirm="onConfirm6"
					@cancel="showPopup6 = false" />
			</van-popup>
			<van-cell is-link title="选项高度" :value="selectedValue7" @click="showPopup7 = true" />
			<van-popup v-model="showPopup7" position="bottom" round>
				<van-picker title="标题" show-toolbar item-height="60px" :columns="columns7" @confirm="onConfirm7"
					@cancel="showPopup7 = false" />
			</van-popup>
			<van-cell is-link title="可见的选项个数" :value="selectedValue8" @click="showPopup8 = true" />
			<van-popup v-model="showPopup8" position="bottom" round>
				<van-picker title="标题" show-toolbar visible-item-count="3" :columns="columns8" @confirm="onConfirm8"
					@cancel="showPopup8 = false" />
			</van-popup>
			<van-cell is-link title="快速滑动时惯性滚动的时长" :value="selectedValue9" @click="showPopup9 = true" />
			<van-popup v-model="showPopup9" position="bottom" round>
				<van-picker title="标题" show-toolbar swipe-duration="6000" :columns="columns9" @confirm="onConfirm9"
					@cancel="showPopup9 = false" />
			</van-popup>
			<!-- 其他用法 -->
			<div style="color: #666666;margin: 0.5rem 0;">其他用法</div>
			<van-cell is-link title="多列选择" :value="selectedValue10" @click="showPopup10 = true" />
			<van-popup v-model="showPopup10" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns10" @confirm="onConfirm10"
					@cancel="showPopup10 = false" />
			</van-popup>
			<van-cell is-link title="级联选择" :value="selectedValue11" @click="showPopup11 = true" />
			<van-popup v-model="showPopup11" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns11" @confirm="onConfirm11"
					@cancel="showPopup11 = false" />
			</van-popup>
			<van-cell is-link title="动态设置选项" :value="selectedValue12" @click="showPopup12 = true" />
			<van-popup v-model="showPopup12" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns12" @confirm="onConfirm12"
					@cancel="showPopup12 = false" @change="onChange12" />
			</van-popup>
			<van-cell is-link title="加载状态" :value="selectedValue13" @click="showPopup13 = true" />
			<van-popup v-model="showPopup13" position="bottom" round>
				<van-picker title="标题" show-toolbar :columns="columns13" :loading="loading" @confirm="onConfirm13"
	...
	export default {
		...
		data() {
			return {
				...
				showPopup4: false,
				selectedValue4: "",
				columns4: ["杭州", "宁波", "温州", "绍兴", "湖州", "嘉兴", "金华", "衢州"],
				showPopup5: false,
				selectedValue5: "",
				columns5: ["杭州", "宁波", "温州", "绍兴", "湖州", "嘉兴", "金华", "衢州"],
				showPopup6: false,
				selectedValue6: "",
				columns6: [
					// 第一个
				...
				showPopup7: false,
				selectedValue7: "",
				columns7: ["杭州", "宁波", "温州", "绍兴", "湖州", "嘉兴", "金华", "衢州"],
				showPopup8: false,
				selectedValue8: "",
				columns8: ["杭州", "宁波", "温州", "绍兴", "湖州", "嘉兴", "金华", "衢州"],
				showPopup9: false,
				selectedValue9: "",
				columns9: ["杭州", "宁波", "温州", "绍兴", "湖州", "嘉兴", "金华", "衢州"],
				showPopup10: false,
				selectedValue10: "",
				columns10: [
					// 第一列
