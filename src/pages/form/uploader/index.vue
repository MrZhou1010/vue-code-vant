<template>
	<div class="uploader">
		...
		<div class="content">
			...
			<van-uploader class="item-uploader" v-model="fileList2" :after-read="afterRead2" />
			<!-- 限制上传数量 -->
			<div style="color: #666666;">限制上传数量</div>
			<van-uploader class="item-uploader" v-model="fileList3" multiple :max-count="2" />
			<!-- 限制上传大小 -->
			<div style="color: #666666;">限制上传大小</div>
			<van-uploader class="item-uploader" v-model="fileList4" multiple :max-size="500 * 1024"
				@oversize="onOversize" />
			<div style="color: #666666;">限制上传大小</div>
			<van-uploader class="item-uploader" v-model="fileList5" multiple :max-size="isOverSize" />
			<!-- 自定义上传样式 -->
			...
			<van-uploader class="item-uploader" v-model="fileList7" :deletable="false" />
		</div>
	</div>
</template>
